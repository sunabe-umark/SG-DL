...
const textFilePath = './downloads/kaitori-shitadori-cleanPrice.txt';
// ==========================================
...
const textFilePath2 = './downloads/chumon-hanbai-cleanPrice.txt';
// ==========================================
// 🌟 ファイルの中身を読み取って、文字列として変数に代入する！
// ==========================================
// 第2引数の 'utf-8' を忘れずに付けるのがポイントです！
...
const filePath7 = './downloads/kaitori-shitadori-cleanPrice.txt';
// 🌟 ファイルが存在するかチェックしてから削除する（エラー防止の鉄則！）
...
const filePath8 = './downloads/chumon-hanbai-cleanPrice.txt';
// 🌟 ファイルが存在するかチェックしてから削除する（エラー防止の鉄則！）
